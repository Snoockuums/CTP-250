...
int main(){
	...
	//Your program must begin by inputting the text data from the WorldHighestPaidAthletes.csv 
	//text file and building a binary search tree for the Athletes, in order by the key 
	//(the last name of the athlete). Then the program must display the main menu
