 ...
 * information corresponding to an athlete: the key (first and last name 
 * together), first name, last name, rank, total earnings, salary/winnings, 
 * endorsements, and sport 
 */ 
#ifndef ATHLETE_H
 ...
 */
const string OUTPUT_FILENAME = "WorldsHighestPaidAthletes.csv";
...
public:
    ...
    * @return counter, tracking number of visits made.
	 */
