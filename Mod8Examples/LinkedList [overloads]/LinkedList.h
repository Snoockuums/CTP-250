...
private:
   ...
   Node<ItemType>* copyListNodes(Node<ItemType>* origChainPtr) const;
   Node<ItemType>* copyThisList() const;
...
public:
   ...
   friend ostream& operator<<(ostream& outStream, const LinkedList<friendItemType>& outputList);
