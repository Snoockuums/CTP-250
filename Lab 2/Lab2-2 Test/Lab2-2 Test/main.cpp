/**
 ...
 This file takes an input string and displays its words backwards. The string must end with a space (because of the method I use to parse the words), and an EOF (per Lab instructions).
